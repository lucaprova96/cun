...
open class FilemoonExtractor : Extractor() {
    ...
    override suspend fun extract(link: String): Video {
        ...
        Log.i("LuceES", "[Filemoon] Extraction started for: $link")

        // 1. Details
        val detailsUrl = "$currentDomain/api/videos/$videoId/embed/details"
        Log.i("LuceES", "[Filemoon] Details Request: $detailsUrl")
        ...
        Log.i("LuceES", "[Filemoon] Playback Domain detected: $playbackDomain")

        // 2. Challenge
        val challengeUrl = "$playbackDomain/api/videos/access/challenge"
        Log.i("LuceES", "[Filemoon] Challenge Request: $challengeUrl")
        ...
        Log.i("LuceES", "[Filemoon] Challenge Data: ID=$challengeId, Viewer=$viewerId")

        // 3. Attestation
        val attestation = generateAttestation(nonce)
        val attestUrl = "$playbackDomain/api/videos/access/attest"
        Log.i("LuceES", "[Filemoon] Attest Request: $attestUrl")
        ...
        Log.i("LuceES", "[Filemoon] Attest Token obtained (Confidence: $confidence)")

        // 4. Playback
        val playbackUrl = "$playbackDomain/api/videos/$videoId/embed/playback"
        Log.i("LuceES", "[Filemoon] Playback Request: $playbackUrl")
        ...
        Log.i("LuceES", "[Filemoon] Decrypting data...")
        ...
        Log.i("LuceES", "[Filemoon] SOURCE FOUND: $sourceUrl")
