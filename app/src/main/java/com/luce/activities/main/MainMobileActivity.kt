...
import com.luce.databinding.ActivityMainMobileBinding
import com.luce.fragments.player.PlayerMobileFragment
...
import com.luce.ui.UpdateAppMobileDialog
...
class MainMobileActivity : FragmentActivity() {
    ...
    private fun handleIntent(intent: Intent): Boolean {
        ...
        if (data.scheme == "Luce" && data.host == "resolve") {
