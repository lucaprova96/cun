package com.luce.fragments.player.settings
...
import com.luce.R
import com.luce.utils.OpenSubtitles
import com.luce.utils.mediaServers
import com.luce.utils.SubDL
import com.luce.utils.UserPreferences
import com.luce.utils.dp
import com.luce.utils.findClosest
import com.luce.utils.getAlpha
import com.luce.utils.getRgb
import com.luce.utils.mediaServerId
import com.luce.utils.mediaServers
import com.luce.utils.setAlpha
import com.luce.utils.setRgb
import com.luce.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.luce.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.luce.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.luce.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.luce.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
