...
import com.luce.utils.CustomTabHelper
...
class PlayerViewModel(
    ...
    private fun getServers(videoType: Video.Type, id: String) = viewModelScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            Log.i("LuceES", "[SERVERS LIST] -> Provider: ${UserPreferences.currentProvider!!.name}")
            Log.i("LuceES", "[SERVERS LIST] -> Found ${servers.size} servers: ${servers.joinToString { it.name }}")
