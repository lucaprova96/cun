...
import com.luce.R
import com.luce.databinding.ItemSettingMobileBinding
import com.luce.databinding.ViewPlayerSettingsMobileBinding
import com.luce.utils.dp
import com.luce.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.luce.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.luce.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.luce.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.luce.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
