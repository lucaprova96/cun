...
import com.luce.providers.Provider.Companion.providers
...
object UserPreferences {
    ...
    var currentProvider: Provider?
        ...
        set(value) {
            ...
            runCatching {
                ArtworkRepairScheduler.schedule(LuceApp.instance, value)
            }
    ...
    var enableTmdb: Boolean
        ...
        set(value) {
            ...
            if (value) {
                runCatching {
                    ArtworkRepairScheduler.schedule(LuceApp.instance, currentProvider)
                }
            }
        }
