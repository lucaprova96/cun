...
import com.luce.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.luce.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {
